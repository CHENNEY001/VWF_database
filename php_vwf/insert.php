...
if ($id <= 0 || $VWD_type === '/'){
    header('Refresh:0.5; url=../html/mutation_add.html');
...
$sql = "insert into mutation values($id, '$Mutant_region', '$VWD_type', '$mutation_type', '$Inheritance', '$Location', '$Nucleotide_change', '$Amino_acid_change', '$References', '$Comments')";
...
header('Refresh:0.5; url=./search.php', $replace=false);
