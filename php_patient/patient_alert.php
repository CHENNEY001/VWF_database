...
$sql = "update patient set `id`=$id, `APTT`='$APTT ', `VWF:Ag(%)`='$VWFAg', `VWF:RCo(%)`='$VWFRCo', `RIPA(1.2mg/ml, %)`='$RIPA', `FVIII:C(%)`='$FVIII', `VWF:CB(%)`='$VWFCB', `VWFpp(%)`='$VWFpp', `Blood Type`='$Blood_Type', `Age`='$Age', `Gender`='$Gender', `BS`='$BS' where id = {$id}";
